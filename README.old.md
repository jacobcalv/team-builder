...
- [ 1] Use `npx create-react-app team-builder` or `create-react-app team-builder` to initiate the project.
- [ 1] CD into your `team-builder` directory
- [ 1] Using the same command tool (yarn or npm) start up the app using `yarn start` or `npm start`
